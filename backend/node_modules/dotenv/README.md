...
```
```sh
$ dotenvx run --debug -- node main.jsx
...
$ echo "console.log('Hello ' + process.env.HELLO)" > main.jsx

$ dotenvx run --env-file=.env.production -- node main.jsx
Hello production
> ^^
```
...
$ dotenvx run --env-file=.env.local --env-file=.env -- node main.jsx
Hello local
```
